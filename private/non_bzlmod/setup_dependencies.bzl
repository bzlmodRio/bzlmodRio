...
load("@bzlmodrio-studica//:maven_cpp_deps.bzl", "setup_legacy_bzlmodrio_studica_cpp_dependencies")
load("@bzlmodrio-studica//:maven_java_deps.bzl", "setup_legacy_bzlmodrio_studica_java_dependencies")
...
def _setup_cpp_dependencies():
    ...
    setup_legacy_bzlmodrio_studica_cpp_dependencies()
...
def _setup_java_dependencies():
    ...
    setup_legacy_bzlmodrio_studica_java_dependencies()
